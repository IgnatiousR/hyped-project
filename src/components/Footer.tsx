    ...
    <footer className="section_footer">
      <div className="cs-footer">
        <div className="cs-footer-cta">
          <h2 className="footer-heading">Let’s Get Hyped!</h2>
          <div className="button-group">
            <Button variant="outline" href="mailto:info@gethyped.nl" icon={mailIcon}>
              Mail ons direct
            </Button>
        ...
        <div className="cs-footer-bottom">
          <div className="footer-bg">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1860 386" fill="none" className="footer-bg-svg">
              <path d="M1859.06 34.8264V349.463C1859.06 365.199 1859.06 380.122 1859.06 385.962L0.642595 385.955C0.642578 383.021 0.642769 379.682 0.642769 371.941V290.843C0.642769 283.856 5.67717 277.887 12.5466 276.741L1819.04 0.740997C1840 -2.74446 1859.06 13.489 1859.06 34.8184" fill="#EAE4D8"></path>
            </svg>
          </div>
