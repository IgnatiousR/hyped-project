    ...
    <section className="section_expertises" ref={sectionRef}>
      <div className="expertises-list">
        {expertises.map((item, index) => (
          <div key={item.id} className="expertise-item" style={{ zIndex: index + 1 }}>
              ...
              <div className={`expertise-content theme-${item.theme}`}>
                ...
                <div className="expertise-content_bottom">
                  <div className="expertise-content_left">
                    <h3 className="expertise-content_subtitle">{item.subtitle}</h3>
                    ...
                    >
                      <span className="expertise-cta-btn__text">{item.cta}</span>
                  ...
                  <div className="expertise-content_right">
                    ...
                    >
                      <img src={item.image} alt={item.title} className="expertise-image" />
                    </div>
                  </div>
                </div>
              </div>
